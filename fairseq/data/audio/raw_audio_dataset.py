    ...
    def __getitem__(self, index):
        ...
        for i in range(retry):
            try:
                ...
                tempwav = torch.load(path_or_fp)
                wav = tempwav.numpy().astype(np.float32)
                curr_sample_rate = 100
                # if sbbbb==0:
                #     print("fuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu")
                #     print("fuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu")
                #     print("wav")
                #     print(wav.shape)
                #     print(curr_sample_rate)
                #     print("fuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu")
                #     print("fuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu")
                #     sbbbb=sbbbb+1
                break
